import { WALK_STANCE_FRACTION, walkFoot, type BodySide, type Point3 } from "../../vendor/pilgrimage/lib/game/base-person/pose"
import { quadrupedBody, animalProfile, type Animal, type HorseVariant, type QuadrupedProfile } from "./transport-core"
